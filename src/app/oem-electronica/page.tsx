      ...
      <div className="xl:pl-72">
        <Section id="entorno" className="scroll-mt-20 py-16 sm:py-20">
          <Reveal className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-sm text-ink-faint">
              Todas operan sobre la misma infraestructura y el mismo contrato.
              Da clic en una solución para ver su ficha completa.
            </p>
          </Reveal>
        ...
        <SectionZone id="seguridad" accent="azul-primario">
          ...
          <Section className="py-16 sm:py-20">
            ...
            />
            <ProductCards
              products={OEM_SEGURIDAD.autonomia.products}
              columns={2}
            />
          </Section>
          ...
          <Section className="py-16 sm:py-20">
            ...
            />
            <ProductCards
              products={OEM_SEGURIDAD.wearables.products}
              columns={2}
            />
          </Section>
        ...
        <SectionZone id="interaccion" accent="azul-corporativo">
          <Section className="py-16 sm:py-20">
            ...
            />
            <FeatureGrid
              features={OEM_INTERACCION.intro.features}
              columns={2}
            />
            <Reveal className="mt-6">
              <p className="font-display text-xl text-verde-acento sm:text-2xl">
        ...
        <SectionZone id="cerraduras" accent="azul-primario">
          ...
          <Section className="py-16 sm:py-20">
            ...
            />
            <FeatureGrid
              features={OEM_CERRADURAS.control.features}
              columns={3}
            />
          </Section>
        </SectionZone>
