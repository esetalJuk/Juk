...
import { OemContentsNav } from "@/components/oem/contents-nav";
import { OemQuienesSomos } from "@/components/oem/quienes-somos";
import { OemDataValor } from "@/components/oem/data-valor";
...
export default function OemElectronicaPage() {
  return (
    <>
      ...
      <SolutionIntro id="seguridad" {...OEM_SEGURIDAD.intro} />
      ...
      {/* 02 — Digital Signage */}
      <SolutionIntro id="signage" {...OEM_SIGNAGE.intro} />
      ...
      <Section id="interaccion" className="scroll-mt-24 py-16 sm:py-20">
        <SectionHeader
      ...
      <SolutionIntro id="ia" {...OEM_IA.intro} fit="contain" />
      ...
      <SolutionIntro id="cerraduras" {...OEM_CERRADURAS.intro} fit="contain" />
      ...
      {/* 06 — Etiquetas ESL */}
      <SolutionIntro id="esl" {...OEM_ESL.intro} />
      ...
      {/* 07 — Antenas EAS */}
      <SolutionIntro id="eas" {...OEM_EAS.intro} />
