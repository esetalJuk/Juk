  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 20% 0%, rgba(0,128,223,0.18), transparent 55%)",
        }}
      />
      <div className="relative mx-auto max-w-[1440px] px-5 sm:px-8">
        ...
        <p
          data-hero-item
          className="mt-6 max-w-xl font-body text-lg normal-case tracking-normal text-ink-muted"
        >
          {pillar.hook}
        </p>
        <p
          data-hero-item
          className="mt-4 max-w-2xl font-body text-base normal-case tracking-normal text-ink-muted/90"
        >
          {pillar.intro}
        </p>
